	...
	<div class="card-group">
			...
			<div class="card bg-gradient-light border-0">	
				...
				<p></p>
					...
					<button class="w3-button w3-block w3-left-align" onclick="myFunction1()" style="font-size:20px">
						No due date <i class="fa fa-caret-down"></i>
					</button>
					<div id="demo1" class="w3-hide w3-card w3-bar-block">
					...
					<button class="w3-button w3-block w3-left-align" onclick="myFunction2()" style="font-size:20px">
						Done early <i class="fa fa-caret-down"></i>
					</button>
					...
					<button class="w3-button w3-block w3-left-align" onclick="myFunction4()" style="font-size:20px">
						Last week <i class="fa fa-caret-down"></i>
					</button>
					<div id="demo4" class="w3-hide w3-card w3-bar-block">
						<a href="#" class="w3-bar-item w3-button">Link</a>
						<a href="#" class="w3-bar-item w3-button">Link</a>
					</div>

				
					<button class="w3-button w3-block w3-left-align" onclick="myFunction5()" style="font-size:20px">
						Earlier <i class="fa fa-caret-down"></i>
					</button>
					<div id="demo5" class="w3-hide w3-card w3-bar-block">
						<a href="#" class="w3-bar-item w3-button">Link</a>
						<a href="#" class="w3-bar-item w3-button">Link</a>
					</div>
			...
			<div class="card bg-gradient-light border-0 align-middle text-right">	
				<a href="To-doAssigned.php" style="padđing-top:20px;"><h3>Assigned</h3></a>
			</div>
			...
			<div class="card bg-gradient-light text-left border-0 align-middle">	
				<a href="To-doDone.php" style="padđing-top:20px;color:red;"><h3>Done</h3></a>
			</div>
